...
-이 어플이 상용화된다면 소형프렌차이즈와 개인카페에서 손님들이 더욱 카페를 이용하는데 시간을 절약 할 수 있고 손님들이 붐비는 이 시점에서 
 
 
 
 ## Ⅲ-2. 소감
 -데이터베이스에 정보를 저장하고 필요한 정보를 불러오는 과정에서 어려움이 있었지만 
개발자의 입장으로 저희 조원끼리 정보를 찾아보고 공부하면 많이 배울 수 있었습니다.
